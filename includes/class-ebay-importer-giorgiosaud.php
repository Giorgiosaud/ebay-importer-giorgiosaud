 ...
 */
class Ebay_Importer_Giorgiosaud {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Ebay_Importer_Giorgiosaud_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	...
	public function __construct() {
		...
		$this->plugin_name = 'ebay-importer-giorgiosaud';
		$this->version = '1.0.0';
	 ...
	 *
	 * - Ebay_Importer_Giorgiosaud_Loader. Orchestrates the hooks of the plugin.
	 * - Ebay_Importer_Giorgiosaud_i18n. Defines internationalization functionality.
	 * - Ebay_Importer_Giorgiosaud_Admin. Defines all hooks for the admin area.
	 * - Ebay_Importer_Giorgiosaud_Public. Defines all hooks for the public side of the site.
	 *
	...
	private function load_dependencies() {
		 ...
		 * core plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-ebay-importer-giorgiosaud-loader.php';
		 ...
		 * side of the site.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'public/class-ebay-importer-giorgiosaud-public.php';

		$this->loader = new Ebay_Importer_Giorgiosaud_Loader();
	 ...
	 *
	 * Uses the Ebay_Importer_Giorgiosaud_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
	...
	private function set_locale() {
		...
		$plugin_i18n = new Ebay_Importer_Giorgiosaud_i18n();
	...
	private function define_public_hooks() {
		...
		$plugin_public = new Ebay_Importer_Giorgiosaud_Public( $this->get_plugin_name(), $this->get_version() );
	 ...
	 *
	 * @since     1.0.0
	 * @return    Ebay_Importer_Giorgiosaud_Loader    Orchestrates the hooks of the plugin.
	 */
